...
def _sample_subjects() -> list[ArchiveSubject]:
    return [
        ArchiveSubject(
            ...
            GaitIDList=["G-E2E-001"],
            MotorVehicleIDList=["MV-E2E-001"],
            NonMotorVehicleIDList=["NMV-E2E-001"],
        ...
        ArchiveSubject(
            ...
            GaitIDList=["G-E2E-002"],
            MotorVehicleIDList=["MV-E2E-002"],
            NonMotorVehicleIDList=["NMV-E2E-002"],
            PersonObjectList=None,
            FaceObjectList=None,
            GaitObjectList=None,
            MotorVehicleObjectList=None,
