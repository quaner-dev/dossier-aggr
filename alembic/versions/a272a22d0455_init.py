...
Revision ID: a272a22d0455
Revises: 
Create Date: 2026-01-31 23:09:36.148086
...
def upgrade() -> None:
    ...
    op.create_table('archivelibrary',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('ArchiveLibraryID', sqlmodel.sql.sqltypes.AutoString(length=48), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('ArchiveLibraryID')
    )
    ...
    sa.Column('SubImageList', sa.JSON(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('BeginTime', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('EndTime', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
