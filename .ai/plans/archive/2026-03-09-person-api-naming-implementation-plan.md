...
```bash
git add tests/test_api_person.py api/person/person.py .ai/plans/archive/2026-03-09-person-api-naming-design.md .ai/plans/archive/2026-03-09-person-api-naming-implementation-plan.md
