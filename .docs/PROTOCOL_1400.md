...
| 方法 | 路径 | 请求模型 | 响应模型 | 说明 |
| --- | --- | --- | --- | --- |
| GET | `/VIID/Persons` | 无 | `PersonListObjectSchema` | 批量人员查询 |
...
| GET | `/VIID/Persons/{person_id: str}` | 路径参数 `person_id` | `Person` | 单个人员查询 |

## 4.4 Face

| 方法 | 路径 | 请求模型 | 响应模型 | 说明 |
| --- | --- | --- | --- | --- |
| GET | `/VIID/Faces` | 可选查询参数 `face_id` | `FaceListObjectSchema` | 人脸查询 |
