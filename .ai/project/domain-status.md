...
| 订阅 Subscribe | `api/subscribe/subscrbe.py` | `SubscribeService` | `repo/subscribe/subscribe.py` + `tasks/subscribe/subscribe.py` | 已实现 |
...
| 聚档任务 ArchiveTask | - | - | - | 未实现，A.6 `/VIAS/Tasks` 不在当前交付范围 |
