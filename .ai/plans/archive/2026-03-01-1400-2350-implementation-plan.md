...
def test_protocol_docs_cover_all_2350_clauses():
    p = Path('.ai/protocols/2350/README.md').read_text(encoding='utf-8')
...
Update `.ai/protocols/2350/README.md` to explicitly list A.5-A.18 and all URI resources.
...
```bash
git add tests/protocol/test_protocol_matrix_guard.py .ai/protocols/2350/README.md .ai/protocols/1400/README.md
...
```bash
git add .ai/project/README.md .ai/protocols/1400/README.md .ai/protocols/2350/README.md .ai/testing/README.md
