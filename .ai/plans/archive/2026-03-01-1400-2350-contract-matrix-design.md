...
- Contract precedence: `.protocol` > `.ai` > current code behavior
...
- `.ai/project/README.md`, `.ai/protocols/1400/README.md`, `.ai/protocols/2350/README.md`, `.ai/testing/README.md` synchronized when contract behavior changes.
